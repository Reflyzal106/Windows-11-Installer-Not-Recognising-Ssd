# [SOLVED] Windows-11-Installer-Not-Recognising-Ssd
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/windows-11-installer-not-recognising-ssd)
>
...
Try using a different USB port or a SATA-to-USB adapter to rule out any issues with the current connection. Also, ensure that the SSD is properly detected by your system's BIOS settings.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/windows-11-installer-not-recognising-ssd)**
